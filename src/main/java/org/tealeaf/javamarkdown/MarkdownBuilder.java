...
public class MarkdownBuilder extends Writer {
    ...
    /**
     * Creates a new {@code MarkdownBuilder}, using a new {@link StringWriter} to handle the writing functionality.
     *
     * @since 0.0.7
     */
     ...
     * @since 0.0.9
     */
    public MarkdownBuilder appendMarkdownElement(MarkdownElement markdownElement) throws IOException {
